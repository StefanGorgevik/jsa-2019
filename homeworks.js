...
var getAllStudents = (req,res) => { console.log('get all students'); };
var getStudent = (req,res) => { res.write('retrieving student with name: ', req.params.name); };
var storeStudent = (req,res) => { console.log('store student'); };
var deleteStudent = (req,res) => { console.log('delete student'); };
var updateStudent = (req,res) => { res.write('updating student with id: '+ req.params.id); };
var patchStudent = (req,res) => { console.log('patch student'); };
